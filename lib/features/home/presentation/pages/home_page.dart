                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      FilledButton.icon(
                        ...
                        label: const Text('Remittance management'),
                        onPressed: () => Navigator.of(context).push(MaterialPageRoute<void>(builder: (_) => const RemittanceManagementPage())),
                      ),
                      const SizedBox(height: 12),
                      FilledButton.icon(
                        icon: const Icon(Icons.receipt_long),
                        label: const Text('Expense management'),
                        onPressed: () => Navigator.of(context).push(MaterialPageRoute<void>(builder: (_) => const ExpenseManagementPage())),
                      ),
                      const SizedBox(height: 12),
                      FilledButton.icon(
                        icon: const Icon(Icons.inventory_2),
                        label: const Text('Grocery stock management'),
                        onPressed: () => Navigator.of(context).push(MaterialPageRoute<void>(builder: (_) => const GroceryStockManagementPage())),
                      ),
                      if (user.isOwner) ...[
                        const SizedBox(height: 12),
                        FilledButton.icon(
                        ...
                        FilledButton.icon(
                          ...
                          label: const Text('Fund management'),
